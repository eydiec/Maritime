...
def WCI_and_TEU():
    try:
        ...
        plt.title('Scatter Plot of WCI Index vs. TEU')
        plt.xlabel('WCI Index')
...
def FBX_and_TEU():
    try:
        ...
        plt.title('Scatter Plot of FBX Index vs. TEU')
...
def BDI_and_Cargo():
    try:
        ...
        plt.title('Scatter Plot of BDI Index vs. Dry Material')
        plt.xlabel('FBX Index')
        plt.ylabel('TEU (Container Throughput)')
        plt.grid(True)
        plt.text(x=max(df_combined['_value_var1']), y=max(df_combined['_value_var2']),
...
def stock_and_TEU_and_cargo():
    try:
        ...
        plt.title('Scatter Plot of Stock Index vs. Container Throughput')
        ...
        plt.title('Scatter Plot of Stock Index vs. Cargo Volume')
        plt.xlabel('Stock Index')
